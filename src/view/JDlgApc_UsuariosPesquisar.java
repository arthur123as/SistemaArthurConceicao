...
public class JDlgApc_UsuariosPesquisar extends javax.swing.JDialog {
     ...
     */
    public JDlgApc_UsuariosPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pesquisar Usuários");
        Apc_UsuariosDao apc_usuariosDao = new Apc_UsuariosDao();
    ...
    public void setTelaPai(JDlgApc_Usuarios jDlgApc_Usuarios) {
        this.jDlgApc_Usuarios = jDlgApc_Usuarios;
    }
    /**
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        Apc_Usuarios apc_usuarios = (Apc_Usuarios) apc_controllerUsuarios.getBean(linSel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgApc_UsuariosPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgApc_UsuariosPesquisar dialog = new JDlgApc_UsuariosPesquisar(new javax.swing.JFrame(), true);
