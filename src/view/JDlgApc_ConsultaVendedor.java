 ...
 * @author Marcos
 */
public class JDlgApc_ConsultaVendedor extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgApc_ConsultaVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgApc_ConsultaVendedor dialog = new JDlgApc_ConsultaVendedor(new javax.swing.JFrame(), true);
