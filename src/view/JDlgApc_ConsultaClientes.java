 ...
 * @author Marcos
 */
public class JDlgApc_ConsultaClientes extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgApc_ConsultaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgApc_ConsultaClientes dialog = new JDlgApc_ConsultaClientes(new javax.swing.JFrame(), true);
