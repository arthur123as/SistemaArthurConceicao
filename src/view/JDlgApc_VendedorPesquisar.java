...
public class JDlgApc_VendedorPesquisar extends javax.swing.JDialog {
     ...
     */
    public JDlgApc_VendedorPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pesquisar Vendedor");
        DAO_ApcVendedor apc_vendedorDao = new DAO_ApcVendedor();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgApc_VendedorPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgApc_VendedorPesquisar dialog = new JDlgApc_VendedorPesquisar(new javax.swing.JFrame(), true);
