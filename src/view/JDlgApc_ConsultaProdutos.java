 ...
 * @author Marcos
 */
public class JDlgApc_ConsultaProdutos extends javax.swing.JDialog {
    ...
    public JDlgApc_ConsultaProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgApc_ConsultaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgApc_ConsultaProdutos dialog = new JDlgApc_ConsultaProdutos(new javax.swing.JFrame(), true);
